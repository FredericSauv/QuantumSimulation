...
dico_simul = {'L':2, 'Nb':2, 'mu':0, 'T':T, 'dt':0.01, 'flag_intermediate':False, 
...
dico_GS = {'L':2, 'Nb':2, 'mu':0, 'T':T, 'dt':0.01, 'flag_intermediate':False, 
...
dico_firstE = {'L':2, 'Nb':2, 'mu':0, 'T':T, 'dt':0.01, 'flag_intermediate':False, 
              'setup':'1', 'state_init':'GS_i', 'state_tgt':'ESS_1_5.0', 'fom':fom_firstE, 
              'fom_print':True, 'track_learning': True, 'ctl_shortcut':'owbds01_pwl15', 
              'kblock':0,'pblock':1}
...
state_tmp = model_firstE.EvolutionPopAdiab(nb_ev =2)
