...
nb_x_init_nm = nb_measures_init / nb_meas
...
cost_onem = measure
cost_nm = lambda x: measure(x, nb_measure = nb_meas)
#iter
nb_iter_onem = 900
...
args_BO = {'acquisition_type':'EI', 'domain': bounds_bo, 'optim_num_anchor':50, 'optim_num_samples':10000}    
