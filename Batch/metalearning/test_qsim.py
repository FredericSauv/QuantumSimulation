...
import sys
sys.path.insert(0, '/home/fred/Desktop/backup_GPYOpt/') # to be changed
import GPyOpt
...
# Test Control function (nothing interesting here)
...
s(np.random.uniform(0.1,5)) # that is the objective function to be maximized
...
# what is stored at the end of the optim
