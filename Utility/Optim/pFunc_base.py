...
# -*- coding: utf-8 -*-
"""
Created on Fri May 25 17:04:58 2018
...
#==============================================================================
class pFunc_atom(SaSed, Bounded, Overwritten):
    """ Abstract class for atomic parametrized functions
    ...
    def __init__(self, params = None, fix_params = False, **args_behavior):
        ...
        #TODO:
        constraints = None, typeSS = 'scale', boundaries = None, listX = None, listY = None
    ...
    def __call__(self, variable):
        """ Call the evaluation of the function. Then apply different behaviors:
        scaling and shifting, bounding and overwritting
        """
...
#-----------------------------------------------------------------------------#            
    def FixParams(self, fixing = True):
